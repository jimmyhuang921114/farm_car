...
#include "motor_if/srv/detail/motor_pos__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motor_if::srv::MotorPos_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const motor_if::srv::MotorPos_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_if::srv::MotorPos_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorPos_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const motor_if::srv::MotorPos_Request *>(
...
static size_t _MotorPos_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorPos_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorPos_Request__callbacks = {
  "motor_if::srv",
  "MotorPos_Request",
...
static rosidl_message_type_support_t _MotorPos_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorPos_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_motor_if
const rosidl_message_type_support_t *
get_message_type_support_handle<motor_if::srv::MotorPos_Request>()
{
  return &motor_if::srv::typesupport_fastrtps_cpp::_MotorPos_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = motor_if::srv::MotorPos_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const motor_if::srv::MotorPos_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<motor_if::srv::MotorPos_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorPos_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const motor_if::srv::MotorPos_Response *>(
...
static size_t _MotorPos_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorPos_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorPos_Response__callbacks = {
  "motor_if::srv",
  "MotorPos_Response",
...
static rosidl_message_type_support_t _MotorPos_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorPos_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &motor_if::srv::typesupport_fastrtps_cpp::_MotorPos_Response__handle;
}
...
static service_type_support_callbacks_t _MotorPos__callbacks = {
  "motor_if::srv",
  "MotorPos",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_if, srv, MotorPos_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_if, srv, MotorPos_Response)(),
...
static rosidl_service_type_support_t _MotorPos__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorPos__callbacks,
...
{
  return &motor_if::srv::typesupport_fastrtps_cpp::_MotorPos__handle;
}
