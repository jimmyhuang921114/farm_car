...
static const _ReceiverData_type_support_symbol_names_t _ReceiverData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rc_receiver_if, msg, ReceiverData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rc_receiver_if, msg, ReceiverData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rc_receiver_if, msg, ReceiverData)() {
  return &::rc_receiver_if::msg::rosidl_typesupport_c::ReceiverData_message_type_support_handle;
}
