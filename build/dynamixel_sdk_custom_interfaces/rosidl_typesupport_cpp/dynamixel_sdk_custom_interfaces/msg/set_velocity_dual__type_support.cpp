...
static const _SetVelocityDual_type_support_symbol_names_t _SetVelocityDual_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_custom_interfaces, msg, SetVelocityDual)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_custom_interfaces, msg, SetVelocityDual)),
  }
};
...
{
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_cpp::SetVelocityDual_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynamixel_sdk_custom_interfaces, msg, SetVelocityDual)() {
  return get_message_type_support_handle<dynamixel_sdk_custom_interfaces::msg::SetVelocityDual>();
}
